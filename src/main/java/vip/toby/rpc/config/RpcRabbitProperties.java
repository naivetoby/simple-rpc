...
public class RpcRabbitProperties {
     ...
     * SSL configuration.
     */
    private final RpcRabbitProperties.Ssl ssl = new RpcRabbitProperties.Ssl();
     ...
     * Cache configuration.
     */
    private final RpcRabbitProperties.Cache cache = new RpcRabbitProperties.Cache();

    /**
     * Listener container configuration.
     */
    private final RpcRabbitProperties.Listener listener = new RpcRabbitProperties.Listener();

    private final RpcRabbitProperties.Template template = new RpcRabbitProperties.Template();

    private List<RpcRabbitProperties.Address> parsedAddresses;
    ...
    public int determinePort() {
        ...
        RpcRabbitProperties.Address address = this.parsedAddresses.get(0);
        return address.port;
    }
    ...
    public String determineAddresses() {
        ...
        for (RpcRabbitProperties.Address parsedAddress : this.parsedAddresses) {
    ...
    private List<RpcRabbitProperties.Address> parseAddresses(String addresses) {
        List<RpcRabbitProperties.Address> parsedAddresses = new ArrayList<>();
        for (String address : StringUtils.commaDelimitedListToStringArray(addresses)) {
            parsedAddresses.add(new RpcRabbitProperties.Address(address));
        }
    ...
    public RpcRabbitProperties.Ssl getSsl() {
        return this.ssl;
    }
    ...
    public RpcRabbitProperties.Cache getCache() {
        return this.cache;
    }

    public RpcRabbitProperties.Listener getListener() {
        return this.listener;
    }

    public RpcRabbitProperties.Template getTemplate() {
    ...
    public static class Cache {
        ...
        private final RpcRabbitProperties.Cache.Channel channel = new RpcRabbitProperties.Cache.Channel();

        private final RpcRabbitProperties.Cache.Connection connection = new RpcRabbitProperties.Cache.Connection();

        public RpcRabbitProperties.Cache.Channel getChannel() {
            return this.channel;
        }

        public RpcRabbitProperties.Cache.Connection getConnection() {
    ...
    public static class Listener {
         ...
         */
        private RpcRabbitProperties.ContainerType type = RpcRabbitProperties.ContainerType.SIMPLE;

        private final RpcRabbitProperties.SimpleContainer simple = new RpcRabbitProperties.SimpleContainer();

        private final RpcRabbitProperties.DirectContainer direct = new RpcRabbitProperties.DirectContainer();

        public RpcRabbitProperties.ContainerType getType() {
            return this.type;
        }

        public void setType(RpcRabbitProperties.ContainerType containerType) {
            this.type = containerType;
        }

        public RpcRabbitProperties.SimpleContainer getSimple() {
            return this.simple;
        }

        public RpcRabbitProperties.DirectContainer getDirect() {
            return this.direct;
        }
    ...
    public abstract static class AmqpContainer {
         ...
         */
        private final RpcRabbitProperties.ListenerRetry retry = new RpcRabbitProperties.ListenerRetry();
        ...
        public RpcRabbitProperties.ListenerRetry getRetry() {
            return this.retry;
        }
     ...
     */
    public static class SimpleContainer extends RpcRabbitProperties.AmqpContainer {
     ...
     */
    public static class DirectContainer extends RpcRabbitProperties.AmqpContainer {
    ...
    public static class Template {
        ...
        private final RpcRabbitProperties.Retry retry = new RpcRabbitProperties.Retry();
        ...
        public RpcRabbitProperties.Retry getRetry() {
            return this.retry;
        }
    ...
    public static class ListenerRetry extends RpcRabbitProperties.Retry {
